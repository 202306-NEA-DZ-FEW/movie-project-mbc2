...
export default function UpComing({ allMovies }) {
    console.log('moviesprom :', allMovies)
    // // console.log("geea3 movies :", allMovies)
    // console.log("id :", id)
    return (
        <MainLayout>
            <h2 className='text-2xl my-8 font-bold'>UPCOMING MOVIES</h2>
...
export async function getServerSideProps(context) {
    ...
    const data = await fetcher(`movie/upcoming?language=en-US&page=1`);
